...
impl BundleKind {
    pub fn subdir(&self) -> &'static str {
        match self {
            ...
            BundleKind::AiTaskBoard => "ai-task-board",
            ...
            BundleKind::OperatorPacket => "operator-packet",
            BundleKind::OperatorPacketSignature => "operator-packet-signature",
